...
- [ ] Review medication changes from the previous visit.
- [ ] Review testing completed since the previous visit.
- [ ] Review the most recent MOCA score. Don't repeat if <=12. Repeat MOCA if done 1 year prior and >12.
...
- [ ] Ask about medication benefit and side effects.
