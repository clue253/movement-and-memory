...
- [ ] Review completed laboratory testing.
- [ ] Review the most recent brain MRI or CT.
- [ ] Review the most recent MOCA score. Don't repeat if <=12. Repeat MOCA if done 1 year prior and >12.
- [ ] Review neuropsychological testing, if completed.
...
- [ ] Ask about mood, sleep, behavior, hallucinations, falls, and safety concerns.
